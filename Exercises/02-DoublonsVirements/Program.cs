...
Console.WriteLine("=== Exercice 2 : Detection de doublons de virements ===\n");
...
var virementsAvecDoublons = new List<Virement>
{
    ...
    new("VIR-1001", 250.00m, "Jean Martin"),      // doublon de VIR-1001
    new("VIR-1004", 40.00m, "Paul Petit"),
    new("VIR-1003", 1200.00m, "Entreprise ABC"),  // doublon de VIR-1003
};

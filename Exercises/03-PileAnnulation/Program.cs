...
Console.WriteLine("=== Exercice 3 : Pile d'annulation d'operations ===\n");
...
{
    var gestionnaire = new GestionnaireOperations(100m);
    gestionnaire.Executer(new Operation(TypeOperation.Depot, 50m));   // solde 150
    gestionnaire.Executer(new Operation(TypeOperation.Retrait, 20m)); // solde 130
    var premiereAnnulation = gestionnaire.Annuler();                 // annule le retrait -> solde 150
